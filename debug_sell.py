#!/usr/bin/env python3
"""
Debug script to test SELL transaction creation
"""
...
def test_sell_creation():
    """Test SELL transaction creation step by step"""
    print("🔍 Testing SELL Transaction Creation")
    print("=" * 50)
